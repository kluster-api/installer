...
*/}}
{{- define "azure-credential-manager.name" -}}
...
*/}}
{{- define "azure-credential-manager.fullname" -}}
...
*/}}
{{- define "azure-credential-manager.chart" -}}
...
Common labels
*/}}
{{- define "azure-credential-manager.labels" -}}
helm.sh/chart: {{ include "azure-credential-manager.chart" . }}
{{ include "azure-credential-manager.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "azure-credential-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "azure-credential-manager.name" . }}
...
{{ define "azure-credential-manager.webhookServiceName" -}}
{{- printf "%s-webhook" (include "azure-credential-manager.fullname" . ) | trunc 63 | trimPrefix "-" -}}
{{- end -}}

{{/*
Prepare certs
*/}}
{{- define "azure-credential-manager.prepare-certs" -}}
{{- if not ._caCrt }}
{{- $caCrt := "" }}
{{- $serverCrt := "" }}
{{- $serverKey := "" }}
...
{{- $ca := genCA "ca" 3650 }}
{{ $cn := include "azure-credential-manager.webhookServiceName" . -}}
