...
[CAPA VPC Peering Operator by AppsCode](https://github.com/kluster-api/capa-vpc-peering-operator) - CAPA VPC Peering Operator for Kubernetes
...
$ helm repo update
$ helm search repo appscode/capa-vpc-peering-operator --version=v2023.12.11
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.12.11
```
...
```bash
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.12.11 --set replicaCount=1
```
...
```bash
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.12.11 --values values.yaml
```
