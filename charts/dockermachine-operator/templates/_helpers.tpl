...
*/}}
{{- define "dockermachine-operator.name" -}}
...
*/}}
{{- define "dockermachine-operator.fullname" -}}
...
*/}}
{{- define "dockermachine-operator.chart" -}}
...
Common labels
*/}}
{{- define "dockermachine-operator.labels" -}}
helm.sh/chart: {{ include "dockermachine-operator.chart" . }}
{{ include "dockermachine-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dockermachine-operator.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dockermachine-operator.name" . }}
...
*/}}
{{- define "dockermachine-operator.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dockermachine-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
