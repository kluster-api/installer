...
$ helm repo update
$ helm search repo appscode/docker-machine-operator --version=v2023.10.1
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2023.10.1 --values values.yaml
```
