...
$ helm repo update
$ helm search repo appscode/docker-machine-operator --version=v2024.7.9
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2024.7.9
```
...
```bash
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2024.7.9 --set replicaCount=1
```
...
```bash
$ helm upgrade -i docker-machine-operator appscode/docker-machine-operator -n kubeops --create-namespace --version=v2024.7.9 --values values.yaml
```
