...
*/}}
{{- define "docker-machine-operator.name" -}}
...
*/}}
{{- define "docker-machine-operator.fullname" -}}
...
*/}}
{{- define "docker-machine-operator.chart" -}}
...
Common labels
*/}}
{{- define "docker-machine-operator.labels" -}}
helm.sh/chart: {{ include "docker-machine-operator.chart" . }}
{{ include "docker-machine-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "docker-machine-operator.selectorLabels" -}}
app.kubernetes.io/name: {{ include "docker-machine-operator.name" . }}
...
*/}}
{{- define "docker-machine-operator.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "docker-machine-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
