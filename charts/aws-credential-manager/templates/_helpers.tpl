...
*/}}
{{- define "aws-credential-manager.name" -}}
...
*/}}
{{- define "aws-credential-manager.fullname" -}}
...
*/}}
{{- define "aws-credential-manager.chart" -}}
...
Common labels
*/}}
{{- define "aws-credential-manager.labels" -}}
helm.sh/chart: {{ include "aws-credential-manager.chart" . }}
{{ include "aws-credential-manager.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aws-credential-manager.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aws-credential-manager.name" . }}
