...
To uninstall the `aws-credential-manager`:

```bash
$ helm uninstall aws-credential-manager -n kubeops
```
...
The following table lists the configurable parameters of the `aws-credential-manager` chart and their default values.
...
| image.repository                   |                                                                                                                                      | <code>aws-credential-manager</code>                                                                                                                                                            |
